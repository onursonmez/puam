...
class ZoomRepository
{
    ...
    public function updateZoomMeeting($data, $liveConsultation)
    {
        ...
        try {
            ...
            if ($e->getCode() == 401) {
                throw new UnprocessableEntityHttpException(__('messages.live_consultation.invalid_token'));
            }
            if ($e->getCode() == 400) {
                throw new UnprocessableEntityHttpException(__('messages.live_consultation.in_progress'));
            }
            if ($e->getCode() == 0) {
                throw new UnprocessableEntityHttpException(__('messages.live_consultation.have_to_connect_zoom'));
            }
