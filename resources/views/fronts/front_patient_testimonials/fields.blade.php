<div class="row">
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::textarea('short_description', null, ['class' => 'form-control', 'placeholder' => __('messages.front_patient_testimonial.short_description'), 'required', 'id' => 'shortDescription', 'rows'=> 5, 'maxlength' => '500']) }}
        </div>
    </div>
    <div class="col-lg-6 mb-7">
        <div class="mb-3" io-image-input="true">
            <label for="exampleInputImage" class="form-label required">{{ __('auth.app.profile') }}:</label>
            <div class="d-block">
