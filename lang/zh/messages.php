...
return [
    ...
    */
    ...
    'welcome_back' => '欢迎回来！',
    'monthly_earning' => '每月收入！',
    'from_previous_month' => '從上個月開始',
    'monthly_expense' => '每月費用！',
    'monthly_appointments' => '每月預約',
    'profile_size' => '个人资料大小应小于2 MB',
    'avatar_size' => '头像大小应小于2 MB',
    'contact_required' => '联系号码字段是必填的',
    'country_required' => '国家字段是必填的',
    'state_required' => '州/省字段是必填的',
    'city_required' => '城市字段是必填的',
    'address_1_required' => '地址1字段是必填的',
    'address_2_required' => '地址2字段是必填的',
    'logo_size' => 'Logo 大小应为90 x 60 像素',
    'favicon_size' => 'Favicon 大小应为32 x 32 像素',
    'name_on_card' => '请输入持卡人姓名',
    'card_number' => '请输入卡号',
    'expiration_month' => '请选择月份',
    'expiration_year' => '请选择年份',
    ...
    'web' => [
        ...
        'testimonial' => '推荐',
        'what_did_they_say_about_us' => '他們對我們說了什麼？',
        'our_team' => '我们的队伍',
        'our_doctor' => '我们的医生',
        'contact_us' => '联系我们',
        'faqs' => '常见问题',
    ...
    'common' => [
        ...
        'error_default_records' => '預設記錄不允許執行此操作。',
        'download' => '下载',
        'select_brand' => '选择品牌',
        ...
        'google_captcha_key_required' => '谷歌驗證碼關鍵字段是必要的。',
        'google_captcha_secret_required' => '需要 Google 驗證碼秘密欄位。',
        'space_not_allowed_in_unique_id_field' => '唯一标识字段不允许有空格',
    ...
    'service' => [
        ...
        'short_description_required' => '简要描述字段是必填的',
    ],
    ...
    'visit' => [
        ...
        'enter_note' => '输入备注',
        'PatientRequired' => '患者字段是必填的',
        'DoctorRequired' => '医生字段是必填的',
    ],
    ...
    'live_consultation' => [
        ...
        'add_credential' => '添加凭据',
        'zoom_api_key' => '縮放 API 金鑰',
        'zoom_api_secret' => '缩放 API 秘密',
        'awaited' => '等待中',
        'finished' => '完成的',
        'generate_oauth' => '如何產生 OAuth 憑證？',
        'select_patient' => '选择患者姓名',
    ...
    'paypal' => [
      'credentials_not_set' => '未设置 API 凭据。请将 API_KEY 和 API_SECRET 设置为环境变量。',
    ],
